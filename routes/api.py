    ...
    def query():
        ...
        try:
            ...
            prompt = (
                ...
                "1. Identify the language of the current question and respond accordingly (e.g., a Vietnamese question receives a Vietnamese answer).\n"
                ...
                "3. For translation requests (e.g., 'dịch sang tiếng Việt'), translate the most recent conversation message into the specified language unless a particular text is provided.\n"
                "4. Incorporate relevant document excerpts into your answer by synthesizing the information into a cohesive response with additional context, citing them as [number] (e.g., [1]) only when the excerpts directly contribute to the answer.\n"
                "5. If document excerpts are irrelevant or insufficient, rely solely on your knowledge to deliver a complete and accurate response without mentioning or citing the excerpts.\n"
                "6. Provide only the answer to the interpreted question in a clear, complete sentence or paragraph, avoiding this prompt, standalone citations, or fragmented phrases (e.g., avoid 'Non-blocking I/O [2]').\n"
                "7. If the question cannot be answered based on the history and excerpts, respond with 'Insufficient information to answer the question' in the same language as the question.\n\n"
                "8. Do not include any citation markers if the excerpts are not used in the response to avoid user confusion\n\n"
